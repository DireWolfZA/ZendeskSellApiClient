...
namespace ZendeskSell.Leads {
    public interface ILeadActions {
        Task<ZendeskSellCollectionResponse<LeadResponse>> GetAsync(int pageNumber, int numPerPage, string email = null, string phone = null, string mobile = null, int? ownerID = null);
