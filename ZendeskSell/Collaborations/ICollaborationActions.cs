...
namespace ZendeskSell.Collaborations {
    public interface ICollaborationActions {
        Task<ZendeskSellCollectionResponse<CollaborationResponse>> GetAsync(int pageNumber, int numPerPage, int? creatorID = null, long? resourceID = null, string resourceType = null);
